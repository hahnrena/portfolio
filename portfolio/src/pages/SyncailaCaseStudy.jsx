...
export default function SyncailaCaseStudy({ project }) {
  ...
  return (
    <PageWrap>
      ...
      <Overview>
        A comprehensive redesign of Syncaila's multi-camera synchronization workflow, transforming a technical utility into an intuitive, production-grade tool that empowers editors to sync complex projects with confidence and speed.
      </Overview>

      <DetailStatsStrip>
        <StatItem>
          <StatLabel>Role</StatLabel>
          <StatValue>Lead UX Designer</StatValue>
        </StatItem>
        <StatItem>
